...
<div class="kasir-sidebar">
    <div class="card shadow-sm h-100 d-flex flex-column">
        ...
        <div class="card-footer bg-light">
            <a href="../auth/logout.php?role=<?= $user_session['role'] ?><?= $tab_token ? '&tab=' . $tab_token : '' ?>" class="btn btn-danger w-100">Logout</a>
        </div>
    </div>
</div>
            ...
            history.forEach(h => {
                ...
                el.innerHTML = `
                    <div class="d-flex justify-content-between">
                        <div><strong>${h.nota}</strong><br><small class="text-muted">${waktu}</small></div>
                        <div class="text-end">
                    ...
                    <div class="mt-1 d-flex gap-1">
                        <a class="btn btn-sm btn-outline-primary" href="struk.php?nota=${encodeURIComponent(h.nota)}" target="_blank">Lihat</a>
                    </div>
                `;
